package top.resty.store.generator;
...
public class CodeGenerator {
   ...
   * 数据库连接字符
   */
  private static final String URL = "jdbc:mysql://127.0.0.1:3306/db_store?allowMutiQueries=true&rewriteBatchedStatements=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai&useSSL=false&autoReconnect=true&allowPublicKeyRetrieval=true&allowPublicKeyRetrieval=true";

  /**
   * 示例：private static final String PARENT_PACKAGE_NAME = "com.example.mybatisplusdemo";
   */
  private static final String PARENT_PACKAGE_NAME = "top.resty.store";
  ...
  protected static void completeGenerator() {
    ...
    String entityPath =
        PROJECT_ROOT_PATH + "/project-entity/src/main/java/com/yourdomain/projectname/entities/" + moduleName;
